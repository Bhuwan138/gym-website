...
const Subscribe=()=>{
    return(
        <div className="mt-20  mx-10 p-4 rounded-xl flex  flex-wrap  justify-around ">
        <div className="text-4xl  min-w-[40%] font-semibold text-center text-mine-shaft-100 mb-2">Ready To Level Up    <span
